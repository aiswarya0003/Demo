...
switch (opt)
 {
case 1:
printf("\nEnter a number: ");scanf("%d", &value);root = newNode(value);
break;
case 2:
printf("\nEnter a number: ");scanf("%d", &value);root = insert(root, value); 
printf("Inorder Traversal after insertion: ");inorderTraversal(root);printf("\n");
break;
case 3:printf("\nEnter a number: ");scanf("%d", &searchv);
...
break;
case 7:
printf("\nEnter a number to be deleted: ");scanf("%d", &key);root = deleteNode(root, key); 
break;
case 8:
