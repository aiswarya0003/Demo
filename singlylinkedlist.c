     ...
     while (1)
      {
        ...
        switch (choice)
         {
          case 1:insertAtHead();printf("Node inserted at head.\n");break;
          case 2:insertTail(); printf("Node inserted at tail.\n");break;
          case 3:deleteAtHead();break;
          case 4:deleteTail(); break;
          case 5:printf("Current List: ");traverse(); break;
